 ...
 * 
 */
public class DirectoryUpdateActions extends HashMap<String, ParameterAction> {
	...
	public DirectoryUpdateActions() {
		super();
		
		//Put actions
		put(Names.ACTION_HELP, Help.ACTION);
		put(Names.ACTION_LICENSE, License.ACTION);
		put(Names.ACTION_LIST, List.ACTION);
		put(Names.ACTION_RECOVER, Recover.ACTION);
	}
